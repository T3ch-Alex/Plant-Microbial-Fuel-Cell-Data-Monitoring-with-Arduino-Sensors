...
// SENSOR BME280
/* Para o sensor BME280, utilizou-se o tutorial do site Last Minute Engineers (2021).
...
// SENSOR LDR
/* O código para este sensor utilizado foi retirado do site Blog da Robótica, 
...
void loop(void) {
    ...
    /* Neste multiplicador, colocamos o valor de mV para cada bit que definimos no setup. */
    ...
    // Aqui em diante imprimimos o resultado de cada variável de cada sensor.
